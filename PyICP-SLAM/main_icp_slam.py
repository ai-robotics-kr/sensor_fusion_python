...
curr_scan_down_pts = Ptutils.random_sampling(first_velo, num_points=args.num_icp_points)
curr_scan_down_pts_2 = Ptutils.random_sampling(second_velo, num_points=args.num_icp_points)
